...
void EXPORT _VI_FUNC viPeek16 (ViSession vi, ViAddr address, ViPUInt16 val16);
void EXPORT _VI_FUNC viPoke16 (ViSession vi, ViAddr address, ViUInt16 val16);
void EXPORT _VI_FUNC viPeek32 (ViSession vi, ViAddr address, ViPUInt32 val32);
void EXPORT _VI_FUNC viPoke32 (ViSession vi, ViAddr address, ViUInt32 val32);
#if defined(_VI_INT64_UINT64_DEFINED)
void EXPORT _VI_FUNC viPeek64 (ViSession vi, ViAddr address, ViPUInt64 val64);
void EXPORT _VI_FUNC viPoke64 (ViSession vi, ViAddr address, ViUInt64 val64);
#endif
/*- Shared Memory Operations ------------------------------------------------*/
ViStatus EXPORT _VI_FUNC viMemAlloc (ViSession vi, ViBusSize size, ViPBusAddress offset);
ViStatus EXPORT _VI_FUNC viMemFree (ViSession vi, ViBusAddress offset);
#if defined(_VI_INT64_UINT64_DEFINED)
ViStatus EXPORT _VI_FUNC viMemAllocEx (ViSession vi, ViBusSize size, ViPBusAddress64 offset);
ViStatus EXPORT _VI_FUNC viMemFreeEx (ViSession vi, ViBusAddress64 offset);
#endif
