...
Attr *newattrx(Session *, ViAttr, int, ViAttrState, ViStatus (*)(Session *, Attr *, void *), ViStatus (*)(Session *, Attr *, ViAttrState));
...
void genericattr(Session *, char *);
GpibIntfc *newgpibintfc(const GpibTab *, size_t naux);
